...
//	console.log("Ronda: '" + ronda.innerHTML + "'")
	if (parseInt(ronda.innerHTML) > 5) {
		ronda.innerHTML = "FI DEL JOC !! <br>La teua puntuació és de " + document.getElementById("puntuacio_actual").innerHTML + " punts";
		document.getElementById("iconPlay").onclick ="";
		document.getElementById("no_la_sap").onclick = "";
	} else {
